...
import { PiArrowSquareIn, PiChartLineUp, PiFile, PiGear, PiHandHeartFill, PiHeart, PiQuestion, PiSquaresFour, PiUsersThree } from "react-icons/pi"
    ...
    <aside className="flex flex-col p-10 gap-12 bg-paua-900 text-white w-[20rem] shrink-0">
      ...
      <ul className="flex flex-col w-full gap-2">
        {list.map(({ path, icon, label }, key) => {
          const active = (path === "/" && pathName === "/empresa") || (path !== "/" && pathName.includes(`/empresa${path}`))
